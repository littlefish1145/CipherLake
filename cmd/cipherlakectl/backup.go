...
var backupCmd = &cobra.Command{
	...
	Long:  "Create, list, restore, verify, and drill backup operations for CipherLake storage",
}
...
var backupDrillCmd = &cobra.Command{
	...
	Long:  "Start a temporary CipherLake instance, feed backup data into it, and verify it can start, read objects, and list buckets",
	RunE: func(cmd *cobra.Command, args []string) error {
		fromPath, _ := cmd.Flags().GetString("from")
		if fromPath == "" {
			return fmt.Errorf("--from flag is required")

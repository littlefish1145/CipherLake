"""CipherLake Object Storage Client.

Provides an S3-compatible client with CipherLake-specific extensions
...
class CipherLakeClient:
    """Client for interacting with CipherLake Object Storage.

    Wraps boto3 S3 client with CipherLake-specific extensions.
    """
